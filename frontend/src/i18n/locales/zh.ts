  ...
  admin: {
    ...
    accounts: {
      ...
      telemetryPrivacyStats: {
        ...
        customRange: '自定义',
        exportStats: '导出统计',
        protectionTotal: '保护总次数',
        protectionSuccessRate: '保护成功率',
        identityConvergence: '身份收敛比',
        activeWindow: '活跃窗口',
        protectionVolumeTrend: '保护量趋势',
        successRateTrend: '成功率趋势',
        pipelineTitle: '保护流水线',
        pipelineStepInbound: '请求入站',
        pipelineStepBody: '正文脱敏',
        pipelineStepHeader: 'Header 收敛',
        pipelineStepTLS: 'TLS 指纹',
        pipelineStepUpstream: '上游转发',
        pipelinePass: '通过',
        pipelineFail: '未通过',
        identityTitle: '身份收敛分析',
        identityRawLabel: '原始身份',
        identityDerivedLabel: '派生身份',
        identityDeviceID: 'Device ID',
        identitySessionID: 'Session ID',
        identityRequestID: '请求 ID',
        identityConvergedToOne: '已收敛为统一身份',
        identityUniqueValues: '{count} 个唯一值',
        trendsTitle: '保护趋势',
        trendsVolume: '保护请求量',
        trendsSuccess: '保护成功数',
        trendsFailure: '保护失败数',
        ...
        accountInfo: '账号信息',
        protectedCountLabel: '累计保护次数',
        noData: '所选时间窗口内暂无遥测隐私保护记录',
        loading: '正在加载遥测隐私统计数据...',
        pass: '通过',
        fail: '失败',
        sectionBodyDetail: '正文脱敏详情',
        sectionHeaderDetail: 'Header 收敛详情',
        sectionTLSDetail: 'TLS & 请求 ID',
        sectionSensitiveAudit: '敏感字段审计边界（不应被记录）',
        metricAuthValue: '认证值',
        metricToken: 'Token',
        metricModel: '模型名',
        metricRequestBody: '请求正文',
        uniqueValues: '{count} 个唯一值',
        convergedToUnified: '已收敛为统一身份',
        regeneratedPerRequest: '每次请求重新生成',
        requestIDNoConvergence: '请求 ID 不收敛，由中转服务为每次上游请求重新生成唯一编号',
        viewLogs: '查看日志',
        exportStatsBtn: '导出统计',
        closeBtn: '关闭',
        selectAccountPrompt: '选择账号后自动加载',
        protectedCountUnit: '万',
