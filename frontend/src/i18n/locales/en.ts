export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataExportIncludeTelemetryPrivacy: '导出遥测隐私保护开关与累计保护次数',
      dataExportIncludeTelemetryPrivacyHint: '取消后，导出文件会移除 telemetry_privacy_enabled 和 telemetry_privacy_protected_count，不影响当前系统内账号。',
      dataImport: 'Import',
      ...
      dataImportTelemetryPrivacy: '为导入的 Anthropic OAuth / Setup Token 账号启用遥测隐私保护',
      dataImportTelemetryPrivacyHint: '默认开启，只补写目标账号的保护开关，不修改 API Key、Bedrock、Vertex、其他平台账号或任何密钥内容。',
      ...
      telemetryPrivacyProtectedShort: 'Protected {count}',
      telemetryPrivacyProtectedCount: 'Telemetry privacy protected {count} times',
      telemetryPrivacyStatsShort: 'Stats',
      telemetryPrivacyStatsTitle: 'View telemetry privacy protection statistics',
      telemetryPrivacyLogsShort: 'Logs',
      telemetryPrivacyLogsTitle: 'View telemetry privacy protection logs',
      telemetryPrivacyStats: {
        title: 'Telemetry Privacy Statistics',
        ...
        protectionTotal: 'Total Protections',
        protectionSuccessRate: 'Success Rate',
        identityConvergence: 'Identity Convergence',
        activeWindow: 'Active Window',
        protectionVolumeTrend: 'Protection Volume Trend',
        successRateTrend: 'Success Rate Trend',
        pipelineTitle: 'Protection Pipeline',
        pipelineStepInbound: 'Inbound Request',
        pipelineStepBody: 'Body Sanitize',
        pipelineStepHeader: 'Header Converge',
        pipelineStepTLS: 'TLS Fingerprint',
        pipelineStepUpstream: 'Upstream Forward',
        pipelinePass: 'Pass',
        pipelineFail: 'Fail',
        identityTitle: 'Identity Convergence Analysis',
        identityRawLabel: 'Original Identity',
        identityDerivedLabel: 'Derived Identity',
        identityDeviceID: 'Device ID',
        identitySessionID: 'Session ID',
        identityRequestID: 'Request ID',
        identityConvergedToOne: 'Converged to unified identity',
        identityUniqueValues: '{count} unique values',
        trendsTitle: 'Protection Trends',
        trendsVolume: 'Protection Volume',
        trendsSuccess: 'Successful',
        trendsFailure: 'Failed',
        endpointDist: 'Endpoint Distribution',
        resultDist: 'Result Distribution',
        timeRangeLabel: 'Time Range',
        accountInfo: 'Account Info',
        protectedCountLabel: 'Cumulative Protected Count',
        noData: 'No telemetry privacy protection records in the selected time window',
        loading: 'Loading telemetry privacy statistics...',
        pass: 'Pass',
        fail: 'Fail',
        sectionBodyDetail: 'Body Sanitization Details',
        sectionHeaderDetail: 'Header Convergence Details',
        sectionTLSDetail: 'TLS & Request ID',
        sectionSensitiveAudit: 'Sensitive Field Audit Boundary (Should Not Be Logged)',
        metricAuthValue: 'Auth Value',
        metricToken: 'Token',
        metricModel: 'Model Name',
        metricRequestBody: 'Request Body',
        uniqueValues: '{count} unique values',
        convergedToUnified: 'Converged to unified identity',
        regeneratedPerRequest: 'Regenerated per request',
        requestIDNoConvergence: 'Request IDs are not converged — a unique ID is regenerated by the relay for each upstream request',
        viewLogs: 'View Logs',
        exportStatsBtn: 'Export Stats',
        closeBtn: 'Close',
        selectAccountPrompt: 'Select an account to load stats',
        protectedCountUnit: 'k',
        protectedCountUnitK: 'k',
      },
