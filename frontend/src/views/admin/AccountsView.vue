          ...
          <template #cell-platform_type="{ row }">
            <div class="flex flex-wrap items-center gap-1">
              ...
              <span
                ...
                :title="t('admin.accounts.telemetryPrivacyTooltip', { dropped: row.extra.telemetry_privacy_stats.dropped_telemetry ?? 0, stripped: (row.extra.telemetry_privacy_stats.stripped_body ?? 0) + (row.extra.telemetry_privacy_stats.stripped_headers ?? 0) })"
              >
